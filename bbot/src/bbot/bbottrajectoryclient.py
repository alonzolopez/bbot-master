...
class BBOTTrajectoryClient():
	def __init__(self):
		...
		self.j2max = math.pi/180.0*(95.0) # radians
		self.j3min = math.pi/180.0*(-100.0) # radians
		self.j3max = math.pi/180.0*(100.0) # radians
		self.j4min = math.pi/180.0*(-120.0) # radians
		self.j4max = math.pi/180.0*(120.0) # radians
		self.j5min = math.pi/180.0*(-30.0) # radians
		self.j5max = math.pi/180.0*(120.0) # radians
